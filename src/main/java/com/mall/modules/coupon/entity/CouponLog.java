...
import com.mall.modules.coupon.utils.CouponProduceChannel;
...
public class CouponLog extends DataEntity<CouponLog> {
    ...
    private Double produceAmount;        // 产生金额
    private String orderNo;        // 订单号
    private String produceChannelZh; // 产生渠道 中文
    ...
    public String getProduceChannelZh() {
        if (StringUtils.isNotBlank(this.produceChannel)) {
            this.produceChannelZh = CouponProduceChannel.produceChannel2Zh(this.produceChannel);
        }
        return produceChannelZh;
    }

    public void setProduceChannelZh(String produceChannelZh) {
        this.produceChannelZh = produceChannelZh;
    }
