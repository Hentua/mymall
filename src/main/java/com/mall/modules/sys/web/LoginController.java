...
public class LoginController extends BaseController {
	 ...
	 * @param model
	 */
	@RequestMapping(value = "${adminPath}/api/getUserInfo", method = RequestMethod.POST)
	public void getUserInfo(HttpServletRequest request, HttpServletResponse response, Model model) {
		User u = UserUtils.getUser();
		renderString(response,ResultGenerator.genSuccessResult(new UserVo(u)));
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "${adminPath}/api/login", method = RequestMethod.POST)
