package com.mall.modules.order.web.wxpay;
...
public class WxPayController {
   ...
   */
  @RequestMapping(value = "/queryRedpack/{mchBillNo}", method = RequestMethod.GET)
   ...
   * @return 保存到本地的临时文件
   */
  @RequestMapping(value = "/downloadBill/{billDate}/{billType}/{tarType}/{deviceInfo}", method = RequestMethod.GET)
   ...
   * @throws WxPayException
   */
  @RequestMapping(value = "/getSandboxSignKey", method = RequestMethod.POST)
   ...
   * @throws WxPayException
   */
  @RequestMapping(value = "/queryCouponStock", method = RequestMethod.POST)
