...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/activity/activityInfo/">活动配置列表</a></li>
		<li class="active"><a href="${ctx}/activity/activityInfo/form?id=${activityInfo.id}">活动配置<shiro:hasPermission name="activity:activityInfo:edit">${not empty activityInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="activity:activityInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
