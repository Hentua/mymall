...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/gift/giftSaleLog/">礼包购买记录列表</a></li>
		<li class="active"><a href="${ctx}/gift/giftSaleLog/form?id=${giftSaleLog.id}">礼包购买记录<shiro:hasPermission name="gift:giftSaleLog:edit">${not empty giftSaleLog.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="gift:giftSaleLog:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="giftSaleLog" action="${ctx}/gift/giftSaleLog/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">购买是否成功（0-购买失败，未完成支付，1-购买成功）：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">礼包商品数量：</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="gift:giftSaleLog:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
