...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/member/memberMerchantCheck/checkLog">商户审核记录</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="memberMerchantCheck" action="${ctx}/member/memberMerchantCheck/checkLog" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="memberMerchantCheck">
			<tr>
				<td><a href="${ctx}/member/memberMerchantCheck/checkLogHis?id=${memberMerchantCheck.id}">
