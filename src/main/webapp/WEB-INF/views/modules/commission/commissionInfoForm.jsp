...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/commission/commissionInfo/">佣金明细列表</a></li>
		<li class="active"><a href="${ctx}/commission/commissionInfo/form?id=${commissionInfo.id}">佣金明细<shiro:hasPermission name="commission:commissionInfo:edit">${not empty commissionInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="commission:commissionInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="commissionInfo" action="${ctx}/commission/commissionInfo/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="commission:commissionInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
